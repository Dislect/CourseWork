...
namespace сoursework.Migrations
{
    ...
    [Migration("20211017121104_AddColEmp")]
    partial class AddColEmp
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("сoursework.Data.Models.ObjectsDB.Employee", b =>
                {
                    b.HasOne("сoursework.Data.Models.ObjectsDB.Position", "idPosition")
                        .WithMany("employees")
                        .HasForeignKey("idPositionid");

                    b.HasOne("сoursework.Data.Models.Store", "idStore")
                        .WithMany("employees")
                        .HasForeignKey("idStoreid");

                    b.Navigation("idPosition");
